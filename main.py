...
def loadEntities(): 
    ...
    player3 = player.Player((75 - 8 * 3.5, 132 - 8 * 3.5), "", (25, game.resolution.y - 167), False, "Green", 3)  # place (0, 0) in the position variable
    player3.texture = player3.getPlayerSprites() 
    player4 = player.Player((75 - 8 * 3.5, 132 - 8 * 3.5), "", (25, game.resolution.y - 167), False, "Yellow", 4)  # place (0, 0) in the position variable
